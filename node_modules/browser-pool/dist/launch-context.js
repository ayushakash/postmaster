...
class LaunchContext {
    constructor(options) {
        ...
        const { id, browserPlugin, launchOptions, proxyUrl, useIncognitoPages, userDataDir = '', } = options;
        this.id = id;
        this.browserPlugin = browserPlugin;
        this.launchOptions = launchOptions;
        this.useIncognitoPages = useIncognitoPages !== null && useIncognitoPages !== void 0 ? useIncognitoPages : false;
